...
class MismatchException : public std::exception
{
    std::string _msg;
public:
    MismatchException(const std::string& msg) : _msg(msg){}
...
public:
  ...
  uint128_t c_420;
  uint128_t c_422;
  uint128_t aes128(uint128_t arg_0, uint128_t arg_1);
  uint128_t c_423;
  uint128_t c_424;
  ...
  void tandem_instr_start_encryption(RTLVerilated* v);
