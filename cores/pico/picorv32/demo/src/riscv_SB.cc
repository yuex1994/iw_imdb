#include "riscv.h"
void riscv::decode_riscv_SB_update() {
  uint5_t tmp_19 = 0 - 1;
  ...
  uint2_t tmp_2451 = 0 - 1;
  c_2451 = static_cast<uint2_t> ((c_2368 >> 0) & tmp_2451);
  c_2523 = c_2451 == 0;
  uint5_t tmp_21 = 0 - 1;
  ...
  uint8_t tmp_2516 = 0 - 1;
  c_2516 = static_cast<uint8_t> ((c_2367 >> 0) & tmp_2516);
  c_2518 = 0;
  c_2518 = static_cast<uint32_t>(c_2516);
  c_2514 = ~255;
  c_2371 = riscv_mem[static_cast<uint32_t> (c_2369)];
  c_2515 = (c_2514 & c_2371);
  c_2520 = (c_2518 | c_2515);
  c_2509 = c_2451 == 1;
  uint8_t tmp_2496 = 0 - 1;
  c_2496 = static_cast<uint8_t> ((c_2367 >> 0) & tmp_2496);
  c_2502 = (static_cast<uint16_t>(c_2496) << 8) + (static_cast<uint16_t>(0));
  c_2504 = 0;
  c_2504 = static_cast<uint32_t>(c_2502);
  c_2492 = ~65280;
  c_2493 = (c_2492 & c_2371);
  c_2506 = (c_2504 | c_2493);
  c_2487 = c_2451 == 2;
  uint8_t tmp_2474 = 0 - 1;
  c_2474 = static_cast<uint8_t> ((c_2367 >> 0) & tmp_2474);
  c_2480 = (static_cast<uint24_t>(c_2474) << 16) + (static_cast<uint24_t>(0));
  c_2482 = 0;
  c_2482 = static_cast<uint32_t>(c_2480);
  c_2470 = ~16711680;
  c_2471 = (c_2470 & c_2371);
  c_2484 = (c_2482 | c_2471);
  uint8_t tmp_2459 = 0 - 1;
  c_2459 = static_cast<uint8_t> ((c_2367 >> 0) & tmp_2459);
  c_2465 = (static_cast<uint32_t>(c_2459) << 24) + (static_cast<uint32_t>(0));
  c_2455 = ~4278190080;
  c_2456 = (c_2455 & c_2371);
  c_2467 = (c_2465 | c_2456);
  c_2489 = (c_2487) ? c_2484 : c_2467;
  c_2511 = (c_2509) ? c_2506 : c_2489;
  c_2525 = (c_2523) ? c_2520 : c_2511;
  mem_update_map[c_2369] = c_2525;
  c_2375 = (riscv_pc + 4);
