...
module mkCPU(CLK,
  ...
  wire [63 : 0]	near_mem$dmem_word64 /*verilator public*/;
  wire [63 : 0]	near_mem$imem_master_araddr,
		near_mem$imem_master_awaddr,
		near_mem$imem_master_rdata,
		near_mem$imem_master_wdata;
  wire [31 : 0] near_mem$dmem_req_addr /*verilator public*/;
 ...
 wire  near_mem$dmem_req_op /*verilator public*/;
 wire  near_mem$dmem_req_sstatus_SUM;

wire   near_mem$dmem_valid /*verilator public*/;
wire   near_mem$imem_exc,
  ...
  reg monitor_s1;
  reg end_of_pipeline /*verilator public*/;
  reg monitor_s1_delay;
  reg monitor_s2 /*verilator public*/;
  reg monitor_s2_nxt;
  ...
  reg monitor_s4_nxt;
  reg monitor_s4;
  reg monitor_s4_delay;

  always @(*) begin monitor_s1 = stage1_rg_full & ~monitor_s1_already; end
            ...
            always @(*) begin monitor_s2_nxt = (monitor_s2 == 0) ? ( s1_to_s2$D_IN & s1_to_s2$EN & monitor_s1 ?  1'b1 : 1'b0) :

              ( s2_to_s3$D_IN & s2_to_s3$EN  ?  1'b0 : 1'b1); end
            ...
            always @(*) begin monitor_s3_nxt = (monitor_s3 == 0) ? ( s2_to_s3$D_IN & s2_to_s3$EN & monitor_s2 ?  1'b1 : 1'b0) :

              (s3_deq$EN & s3_deq$D_IN ? 1'b0 : 1'b1) ; end
            ...
            always @(*) begin monitor_s4_nxt =
              ...
              monitor_s3 && rg_retiring$EN ? 1'b1 : monitor_s4; end
            ...
            always @(*) begin end_of_pipeline = monitor_s4 && ~monitor_s4_delay ;
   
    end // just check one cycle 
